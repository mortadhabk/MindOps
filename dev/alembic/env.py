...
from app.agent import models as agent_models  # noqa: F401  registre les tables sur Base.metadata
...
# Model modules are imported here so their tables register on Base.metadata
# for autogenerate as each module (rag, gating, audit, ...) adds models.
