...
- **Palette** : glisser un type de connecteur (Document à venir, GitHub Issues, SharePoint) sur le canvas ouvre un formulaire de configuration **généré automatiquement** depuis le JSON Schema de `Connector.config_schema` — aucune duplication de la définition des champs entre back et front.
