...
SYSTEM_PROMPT = (
    ...
    "suis cette méthode avant de répondre :\n"
    "1. Cherche d'abord le symptôme signalé tel quel.\n"
    "2. Repère dans les résultats le flux/module/composant concerné (ex : « flux 4.13 », "
    "« portail ENIX »), puis relance une recherche ciblée sur ce nom précis — d'autres tickets "
    "(ouverts OU résolus) sur le même flux, et les documents de spécifications qui décrivent son "
    "fonctionnement attendu, ne remontent pas forcément avec la première requête.\n"
    "3. Priorise les tickets résolus/fermés portant sur la même cause racine : leur résolution "
    "EST la solution à proposer, pas une piste d'investigation générique à faire manuellement.\n"
    "4. Réponds avec un diagnostic et une solution concrets, construits à partir de ce que tu as "
    ...
    "après plusieurs recherches sous des angles différents — jamais par défaut.\n"
